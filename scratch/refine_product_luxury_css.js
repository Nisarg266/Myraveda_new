...
/* 2. MEDIA GALLERY — COMPACT LUXURY SHOWCASE (CAROUSEL & GRID SAFEGUARD) */
...
.media-gallery slideshow-slides {
  ...
  box-shadow: 0 8px 28px rgba(14, 40, 31, 0.05) !important;
...
.media-gallery slideshow-slide:hover img {
  transform: scale(1.03);
}

/* Safeguard if theme renders in Grid presentation */
...
button.slideshow-controls__thumbnail:hover,
...
.product-media-gallery__thumbnail-button:hover {
  ...
  box-shadow: 0 4px 12px rgba(201, 158, 62, 0.22) !important;
}

.slideshow-controls__thumbnail[aria-selected="true"],
.slideshow-controls__thumbnail.is-active,
...
.product-media-gallery__thumbnail-button.is-active {
  ...
  box-shadow: 0 0 0 2px #C99E3E, 0 4px 14px rgba(201, 158, 62, 0.25) !important;
  transform: scale(1.05) !important;
}

.slideshow-controls__thumbnail img,
.product-media-gallery__thumbnail-button img {
  width: 100% !important;
...
fs.writeFileSync(path, baseCSS + refinedProductCSS, 'utf8');
console.log('Successfully written refined product luxury CSS!');
